      ...
      >
        ...
        <div className="relative h-[40vh] flex items-center">
          ...
          <div className="absolute inset-0 z-0">
            ...
            {/* Arc gradient overlay top-left */}
            <div className="absolute top-0 left-0 w-1/3 h-1/3 bg-gradient-to-br from-amber-500/10 via-purple-900/60 to-black/80 rounded-br-full z-20 blur-xl"></div>
          </div>
            ...
            <div className="flex flex-wrap gap-3 justify-center mb-8">
              {CATEGORIES.map(category => (
                <button
                  ...
                  className={`px-5 py-2 rounded-full text-sm font-medium transition-all min-w-[44px] min-h-[44px] ${
        ...
        {/* Masonry Grid - with exact class names from requirements */}
        <Section>
          <Container>
            <section className="columns-2 sm:columns-3 lg:columns-4 xl:columns-5 gap-x-3.5 md:gap-x-4.5 space-y-4">
            ...
            {filteredItems.length === 0 && (
              <div className="py-20 text-center">
                <h3 className="text-2xl text-neutral-400 mb-4">
        ...
        {/* CTA Strip - Gold gradient with "Inspired? Book Now" */}
        <div className="py-12 bg-gradient-to-r from-amber-600 to-amber-800">
          <Container>
            <div className="flex flex-col md:flex-row items-center justify-between gap-6">
              <div>
                <h3 className="text-2xl font-bold text-white mb-2">Inspired? Book Now</h3>
                <p className="text-white/80">Experience the KARI STYLEZ magic for yourself.</p>
              </div>
              <Link href="/booking">
                <Button size="lg" className="bg-black text-white hover:bg-neutral-900 min-w-[44px] min-h-[44px]">
                  Book Appointment
                </Button>
              </Link>
            </div>
