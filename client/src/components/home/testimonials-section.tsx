...
export default function TestimonialsSection() {
  ...
  return (
    <section className="relative py-16 md:py-24 bg-gradient-to-b from-purple-50 to-white dark:from-purple-950/20 dark:to-neutral-950">
      {/* Decorative elements */}
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="max-w-3xl mx-auto text-center mb-12 md:mb-16">
          ...
          <h2 className="text-3xl md:text-5xl font-bold mb-3 md:mb-4 bg-gradient-to-r from-purple-600 to-fuchsia-600 dark:from-purple-400 dark:to-fuchsia-400 text-transparent bg-clip-text">
        ...
        <div className="relative mb-12 md:mb-20 group">
          ...
          <div className="relative glassmorphism rounded-xl overflow-hidden z-10">
            <div className="grid grid-cols-1 md:grid-cols-2">
              ...
              <div className="p-5 md:p-10 flex flex-col justify-center bg-white/95 dark:bg-neutral-900/95">
                ...
                <p className="text-base md:text-xl italic text-neutral-700 dark:text-neutral-300 leading-relaxed mb-6 md:mb-8">
                ...
                <div className="flex items-center mt-auto">
                  ...
                  <div className="ml-3 md:ml-4">
                    <h4 className="font-semibold text-base md:text-lg bg-gradient-to-r from-purple-600 to-fuchsia-600 dark:from-purple-400 dark:to-fuchsia-400 text-transparent bg-clip-text">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-8">
          {displayTestimonials.slice(1).map((testimonial, index) => (
            <div key={testimonial.id} className="luxury-card group">
              <div className="relative z-10 bg-white dark:bg-neutral-900 p-5 md:p-8 rounded-xl h-full flex flex-col">
                {/* Decorative element */}
                ...
                <p className="mb-4 md:mb-6 italic text-neutral-700 dark:text-neutral-300 leading-relaxed flex-grow text-sm md:text-base line-clamp-4 md:line-clamp-6">
        ...
        <div className="mt-12 md:mt-20 text-center">
          ...
          <h3 className="text-xl md:text-2xl font-semibold mb-4 md:mb-6">Share Your Experience</h3>
          <button className="glow-button text-sm md:text-base py-2 md:py-3 px-4 md:px-6">
